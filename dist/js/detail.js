...
// EXTERNAL MODULE: ./src/assets/js/fancybox.umd.js
var fancybox_umd = __webpack_require__(252);
...
;// CONCATENATED MODULE: ./src/detail/script.js
...
waitDom().then(function (res) {
  var swiper = new Swiper('.js-similar-slider', {
  ...
  var input = document.querySelector('.js-number-input');
  var minus = input.parentNode.querySelector('.js-number-input-minus');
  var plus = input.parentNode.querySelector('.js-number-input-plus');
  minus.onclick = function (e) {
    if (Number(input.value) < 2) return;
    input.value = "".concat(Number(input.value) - 1);
  };
  plus.onclick = function (e) {
    input.value = "".concat(Number(input.value) + 1);
  };
});
;// CONCATENATED MODULE: ./src/detail/index.js
